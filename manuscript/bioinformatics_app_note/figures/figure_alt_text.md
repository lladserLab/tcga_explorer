...
sensitivity. The request can declare an endpoint-by-scoring-by-cutpoint family,
and the branches feed a specification curve plus explicit cutpoint, RMST,
proportional-hazards, events-per-parameter and Firth-sensitivity diagnostics.
