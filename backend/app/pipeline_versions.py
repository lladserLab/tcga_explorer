...
ANALYSIS_PIPELINE_VERSION = "server-attested-competing-risk-contract-v6.12"
COMBINED_SIGNATURE_PIPELINE_VERSION = "server-attested-competing-risk-contract-v4.4"
MULTIVERSE_PIPELINE_VERSION = "server-attested-prespecified-multiverse-contract-v2.1"
